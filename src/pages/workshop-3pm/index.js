        ...
        <div className="max-w-5xl mx-auto grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-6 pt-10 px-4">
            ...
            <div className="divide-y divide-dashed divide-lt-dark-500">
              ...
              <ul className="fa-ul p-4 ml-2">
                ...
                <p>Wednesday, September 25th @ 3PM EST</p>
              </ul>
            </div>
          </div>
          <div className="col-span-12 lg:col-span-6 bg-gray-100 pt-10">
            <div className="text-center text-xl lg:text-2xl font-bold mb-4">
              ...
              <p className="text-blue-gray-700">Wednesday, September 25th @ 3PM EST</p>
            </div>
            <div className="countdown py-2 px-4">
              <Flip value={"2019-09-25T15:00:00-04:00"}/>
            </div>
            ...
            <div className="p-4 px-16">
              <div className="grid grid-cols-2 gap-2">
                  <a href="https://www.addevent.com/event/Yo3878449+google" target="_blank" rel="noreferrer">
                    <img className="w-full" src={googleCal} alt="Add to Google"/>
                  </a>
                  <a href="https://www.addevent.com/event/Yo3878449+apple" target="_blank" rel="noreferrer">
                    <img className="w-full" src={iCal} alt="Add to iCalendar"/>
                  </a>
                  <a href="https://www.addevent.com/event/Yo3878449+outlook" target="_blank" rel="noreferrer">
            ...
            <div className="p-4">
              <p className="text-center text-xl font-bold text-blue-gray-700">On Wednesday, September 25th @ 2:45PM EST, check your email for your join link to join us live!</p>
            </div>
          </div>
        </div>
